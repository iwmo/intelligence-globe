...
| 33. Viewport Culling | 4/4 | Complete   | 2026-03-14 | — |

### Phase 33: Viewport Culling — Load Layers by Visible Globe Region

**Goal:** API requests for aircraft, ships, and military aircraft carry a camera-derived bounding box; the backend filters to only the visible globe region. Zooming in reduces payload size proportionally. Playback mode is unaffected.
**Requirements:** VPC-01, VPC-02, VPC-03, VPC-04, VPC-05, VPC-06, VPC-07, VPC-08
**Depends on:** Phase 32
**Plans:** 4/4 plans complete

Plans:
- [ ] 33-01-PLAN.md — Wave 0 test scaffolds (failing tests for all 8 requirements)
- [ ] 33-02-PLAN.md — Store bbox slice + useViewportBbox hook + App.tsx wiring
- [ ] 33-03-PLAN.md — Backend bbox filtering on aircraft, ships, and military routes
- [ ] 33-04-PLAN.md — Frontend hook wiring (useAircraft, useShips, useMilitaryAircraft) + full suite verification
